...
class TestQA:
    def test_upload_txt_document(self, client: TestClient, auth_headers):
    ...
    def test_upload_unsupported_file(self, client: TestClient, auth_headers):
    ...
    def test_upload_duplicate_document(self, client: TestClient, auth_headers):
    ...
    def test_ask_question_without_documents(self, client: TestClient, auth_headers):
    ...
    def test_ask_question_with_document(self, client: TestClient, auth_headers):
    ...
    def test_delete_nonexistent_document(self, client: TestClient, auth_headers):
        """Test deleting non-existent document"""
        response = client.delete("/qa/documents/99999", headers=auth_headers)
        assert response.status_code == 404
        assert "not found" in response.json()["detail"]

    def test_query_history(self, client: TestClient, auth_headers):
